...
//    _spi.frequency(15000000);  //SPI Clock = 15MHz
//    _spi.frequency(10000000);  //SPI Clock = 10MHz
//    _spi.frequency(5000000);  //SPI Clock = 5MHz
//    _spi.frequency(1000000);  //SPI Clock = 1MHz
...
//    _spi.QSPI_ENABLE();
//    for(i=0; i<(PAGE_SIZE_QSPI_NAND); i++) {
//        buf[i] = _spi.QSPI_WRITE_READ(0x00);
//    }
//    // wait tx finish
//    while( _spi.QSPI_IS_BUSY());
//    _spi.QSPI_DISABLE();
...
//void QSPI_FLASH::QSPI_NOR_ChipErase(void)
//{
//    // /CS: active
//    _spi.QSPI_SET_SS_LOW();
//
...
//void QSPI_FLASH::QSPI_NOR_WaitReady() {
//    volatile uint8_t ReturnValue;
//
//    do
//    {
//        ReturnValue = QSPI_NOR_ReadStatusReg1();
...
//void QSPI_FLASH::QSPI_NOR_Select() {
//    _cs = 0;
//}

//void QSPI_FLASH::QSPI_NOR_Deselect() {
//    _cs = 1;
//}

//void QSPI_FLASH::QSPI_NOR_Hold() {
//    _hold = 0;
//}

//void QSPI_FLASH::QSPI_NOR_Unhold() {
//    _hold = 1;
//}

//void QSPI_FLASH::QSPI_NOR_WriteEnable() {
//    _spi.QSPI_SET_SS_LOW();
////    QSPI_NOR_Unhold();
//    _spi.write(CMD_WRITE_ENABLE);
//    _spi.QSPI_SET_SS_HIGH();
...
//void QSPI_FLASH::QSPI_NOR_WriteDisable() {
//    _spi.QSPI_SET_SS_LOW();
////    QSPI_NOR_Unhold();
//    _spi.write(CMD_WRITE_DISABLE);
//    _spi.QSPI_SET_SS_HIGH();
...
//uint16_t QSPI_FLASH::QSPI_NOR_Page_Program(uint32_t addr, uint8_t *buf) {
//    _spi.QSPI_SET_SS_LOW();
////    QSPI_NOR_Unhold();
//    _spi.write(CMD_PAGE_PROGRAM);
//    _spi.write(addr>>16);       // A23-A16
...
void QSPI_FLASH::QSPI_NOR_QuadIputPageProgram(uint32_t StartAddress, uint8_t *u8DataBuffer,uint32_t mode_4B){
    uint32_t i = 0;
