...
//#define CMD_NOR_BLOCK_ERASE           0xD8
...
//    void QSPI_NAND_ReadID(uint8_t* d);
...
//    void     QSPI_NOR_ChipErase(void);
//    void     QSPI_NOR_WaitReady(void);  //check busy bit of flahs status regster
    ...
    void     QSPI_NOR_QuadIputPageProgram(uint32_t StartAddress, uint8_t *u8DataBuffer, uint32_t mode_4B);
    
//    void QSPI_NOR_WriteEnable();
//    void QSPI_NOR_WriteDisable();
...
//  uint8_t  QSPI_W74M_StatusRead    (void);
